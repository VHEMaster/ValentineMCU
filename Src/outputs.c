...
void out_main(void)
{
  ...
  effect_fill(0);
  osDelay(1000);
  effect_print("Приветик, Натуся :з",90);
  effect_fill_special(3);
  effect_smile1();
  osDelay(700);
  ...
  effect_fill(0);
  osDelay(1000);
  effect_print("Сейчас смотрю я на тебя и вижу блеск в твоих глазах",90);
  effect_fill_special(3);
  osDelay(1000);

  effect_print("Моей принцессой оказалась, не уж царица ты моя?",90);
  osDelay(1000);
  ...
  while(1)
  {
    ...
    osDelay(1000);
    effect_print("Улыбка будто солнцем греет, согревает красотой",90);
    effect_fill_special(1);
    osDelay(500);
    effect_print("Неуклонно тянет с нею в райский, нежный уголок",90);
    effect_fill_special(2);
    effect_print("Полюбил тебя внезапно, будто знал уже, всегда",90);
    effect_fill_special(2);
    effect_print("С Валентином, дорогая, мы с тобой навек - как два",90);
    effect_smile();
    ...
    osDelay(500);
    effect_print("Наташа, солнышко, моя,",90);
    effect_fill_special(5);
    effect_print("Люблю я, милая, тебя!",90);
    osDelay(500);
    effect_print("Твой Максим",90);
    effect_decreasebright(1500, BRIGHT_MAX / 4);
    osDelay(500);
